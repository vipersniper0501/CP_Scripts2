...
if [ $TRAVIS_OS_NAME = 'osx' ]; then
    ...
    pyinstaller --noconfirm --onefile --console --icon "./GUIs/ScriptRunnerPyQt5_GUI/images/cup2.ico" --name "AppleCIDR_Windows_x64" --version-file "./GUIs/ScriptRunnerPyQt5_GUI/version.txt" --uac-admin --add-data "./GUIs/ScriptRunnerPyQt5_GUI/resources.qrc;." --add-data "./GUIs/ScriptRunnerPyQt5_GUI/resources_rc.py;." --add-data "./GUIs/ScriptRunnerPyQt5_GUI/scripFunc;scripFunc/" --add-data "./GUIs/ScriptRunnerPyQt5_GUI/PyUIs;PyUIs/" --add-data "./GUIs/ScriptRunnerPyQt5_GUI/images;images/" --add-data "./GUIs/ScriptRunnerPyQt5_GUI/configurations;configurations/"  "./GUIs/ScriptRunnerPyQt5_GUI/ScriptGUIrunner.py"

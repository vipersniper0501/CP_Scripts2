...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(10, 600, 341, 31))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Note: any command with a * is either not completed yet or broken "))

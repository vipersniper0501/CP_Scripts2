...
class Ui_rmvusrogru(object):
    def setupUi(self, rmvusrogru):
        ...
        rmvusrogru.resize(302, 410)
        rmvusrogru.setWindowTitle("")
        rmvusrogru.setStyleSheet("background-color: #212434\n"
"            ")
        self.Name_Input = QtWidgets.QLineEdit(rmvusrogru)
        self.Name_Input.setGeometry(QtCore.QRect(100, 330, 191, 21))
        ...
        self.label2.setGeometry(QtCore.QRect(10, 330, 91, 21))
        ...
        self.Cancel_button.setGeometry(QtCore.QRect(200, 370, 91, 31))
        font = QtGui.QFont()
...
"}")
        ...
        self.listOFnames.setGeometry(QtCore.QRect(10, 40, 281, 271))

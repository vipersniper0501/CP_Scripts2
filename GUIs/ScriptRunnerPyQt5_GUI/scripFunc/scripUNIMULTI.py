...
def Update_OS():
    ...
    NewThread(os_update, False, "Update_OS")
            ...
            for root, dirs, files in os.walk('C:\\Users\\'):
                for filename in files:
                    if any(filename.endswith(extension) for extension in extensions):
                        ...
                        print(filepath)
            print('Scan for unapproved media complete.')
    NewThread(search_media, False, "Media_Search")
...
def Configure_Services(ssh: bool, samba: bool, web: bool, apaweb: bool, nginweb: bool, ftp: bool, proftpd: bool, vsftpd: bool):
    ...
    # NOTE: This might not work... Needs testing
    NewThread(servSet, False, "Configure_Services", ssh, samba, web, apaweb, nginweb, ftp, proftpd, vsftpd)
...
def Basic_Configurations(rdp):
    ...
    NewThread(basConf, False, "Basic_Configurations", rdp)

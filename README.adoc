...
image:https://github.com/vipersniper0501/CP_Scripts2/workflows/Python%20application%20(Ubuntu)/badge.svg?branch=GUI-Updates&event=push[Python application (Ubuntu)] +
